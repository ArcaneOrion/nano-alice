"""Scheduler tool for scheduling reminders and tasks.

Renamed from cron.py to match the scheduler module.
"""
...
class SchedulerTool(Tool):
    """Tool to schedule reminders and recurring tasks (renamed from CronTool)."""
    ...
    def _add_job(
        ...
        delete_after = False
        if every_seconds:
            schedule = Schedule(kind="every", every_ms=every_seconds * 1000)
        elif cron_expr:
