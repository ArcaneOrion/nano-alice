...
from nano_alice.agent.tools.filesystem import ReadFileTool, WriteFileTool, EditFileTool, ListDirTool
from nano_alice.agent.tools.shell import ExecTool
from nano_alice.agent.tools.web import WebSearchTool, WebFetchTool, make_search_tool
...
class SubagentManager:
    ...
    async def _run_subagent(
        ...
        try:
            ...
            tools = ToolRegistry(workspace=self.workspace, allowed_dir=allowed_dir)
            ...
            tools.register(make_search_tool(
