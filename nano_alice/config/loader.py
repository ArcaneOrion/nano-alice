...
def get_config_path() -> Path:
    ...
    return Path.home() / ".nano-alice" / "config.json"
...
def _migrate_env_vars() -> None:
    """Copy NANOBOT_* env vars to NANO_ALICE_* if the new ones are not set."""
...
def load_config(config_path: Path | None = None) -> Config:
    ...
    # Migrate from legacy nanobot config
    if not path.exists():
