...
class Session:
    ...
    last_memory_processed: int = 0  # Cursor: messages[:cursor] already processed by memory agent
    ...
    def _load(self, key: str) -> Session | None:
        ...
        try:
            ...
            with open(path, encoding="utf-8") as f:
                for line in f:
                    ...
                    if data.get("_type") == "metadata":
                        ...
                        last_memory_processed = data.get("last_memory_processed", 0)
                    else:
            ...
            return Session(
                ...
                last_memory_processed=last_memory_processed,
            )
    ...
    def save(self, session: Session) -> None:
        ...
        with open(path, "w", encoding="utf-8") as f:
            metadata_line = {
                ...
                "last_memory_processed": session.last_memory_processed,
            }
