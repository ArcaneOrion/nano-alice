...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        if self.config.channels.telegram.enabled:
            try:
                from nano_alice.channels.telegram import TelegramChannel
        ...
        if self.config.channels.discord.enabled:
            try:
                from nano_alice.channels.discord import DiscordChannel
        ...
        if self.config.channels.mochat.enabled:
            try:
                from nano_alice.channels.mochat import MochatChannel
        ...
        if self.config.channels.dingtalk.enabled:
            try:
                from nano_alice.channels.dingtalk import DingTalkChannel
        ...
        if self.config.channels.email.enabled:
            try:
                from nano_alice.channels.email import EmailChannel
        ...
        if self.config.channels.slack.enabled:
            try:
                from nano_alice.channels.slack import SlackChannel
        ...
        if self.config.channels.qq.enabled:
            try:
                from nano_alice.channels.qq import QQChannel
