...
def mock_prompt_session():
    ...
    with patch("nano_alice.cli.commands._PROMPT_SESSION", mock_session), \
         patch("nano_alice.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("nano_alice.cli.commands.PromptSession") as MockSession, \
         patch("nano_alice.cli.commands.FileHistory") as MockHistory, \
